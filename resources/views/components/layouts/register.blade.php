...
<head>
    ...
    <!-- Libs JS -->
    <script src="{{ asset('dist/libs/apexcharts/dist/apexcharts.min.js?1684106062') }}" defer data-navigate-track>
    </script>
    <script src="{{ asset('dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062') }}" defer data-navigate-track>
    </script>
    <script src="{{ asset('dist/libs/jsvectormap/dist/maps/world.js?1684106062') }}" defer data-navigate-track></script>
    <script src="{{ asset('dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062') }}" defer data-navigate-track>
    </script>
    <!-- Tabler Core -->
    ...
    <script src="{{ asset('dist/libs/tom-select/dist/js/tom-select.base.min.js?1695847769') }}" defer data-navigate-track></script>
            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item dropdown">
                        <span class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
