                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-dark">
                                                ...
                                                <input type="file"
                                                    ...
                                                    wire:model.live="foto" accept="image/jpeg,image/png,image/jpg" />
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-dark mb-2">
                                                ...
                                                <input type="file"
                                                    ...
                                                    wire:model.live="dni" accept="image/jpeg,image/png,image/jpg" />
                                                @error('dni')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-xxl-4 col-xl-6 col-lg-6">
                                    <div
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-column">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="m-auto" width="85"
                                                    height="85" viewBox="0 0 24 24" stroke-width="1.5"
                                                ...
                                                <a href="{{ route('reporte.ficha-matricula', $inscripcion->id) }}" target="_blank" class="btn btn-indigo mt-3" wire:click="guardar_foto">
                                                    Descargar Ficha de Matrícula
                                                </a>
                                            </div>
                                            @else
                                                ...
                                                <div class="alert alert-important alert-danger mb-0">
                                                    <div class="text-center">
                                                        Ups... el administrador del sistema aún <strong>no valida tu
                                                            matrícula</strong>, esta verificación puede tardar hasta 24
                                                        horas.
                                                    </div>
                                                </div>
                                            </div>
