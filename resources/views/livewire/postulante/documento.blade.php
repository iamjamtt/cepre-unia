    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="alert alert-info m-0 mb-3 fw-bold animate__animated animate__fadeIn animate__faster">
                A continuación se muestra el panel de documentos, en el cual podrá visualizar los documentos que ha
                subido y subir nuevos documentos.
            </div>
            <div class="row g-3">
                <div class="col-12">
                            ...
                            <table class="table card-table table-vcenter text-nowrap table-striped  datatable">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap justify-content-end">
                                                    ...
                                                    @endif
                                                    @if ($item['archivo'])
                                                        <button type="button" class="btn btn-sm btn-outline-indigo"
                                                            data-bs-toggle="modal" data-bs-target="#modal-documento"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap justify-content-end">
                                                <a href="{{ route('reporte.carta-compromiso', $inscripcion->id) }}"
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-azure" disabled>
                                                    Editar
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap justify-content-end">
                                                <a href="{{ route('reporte.declaracion-jurada', $inscripcion->id) }}"
                                                    target="_blank" class="btn btn-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon"
                                                        width="24" height="24" viewBox="0 0 24 24"
                                                        stroke-width="2" stroke="currentColor" fill="none"
                ...
                <form autocomplete="off" novalidate wire:submit="guardar_documento">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                            aria-label="Close" wire:click="limpiar_modal">
                            Cancelar
                        </button>
